...
//=========================================================
#define GRUNT_GUN_STANDING_POSITION		Vector( 0, 0, 60 )
#define GRUNT_GUN_CROUCHING_POSITION	Vector( 0, 0, 48 )

#define GRUNT_HACKED_GUN_POSITION		Vector( 0, 0, 55 )
...
// LINK_ENTITY_TO_CLASS(monster_human_grunt, CBaseGrunt);

BEGIN_DATADESC(CBaseGrunt)
...
IMPLEMENT_SAVERESTORE(CBaseGrunt, CSquadMonster);

const char *CBaseGrunt::pGruntSentences[] =
{
...
const char* CBaseGrunt::pDeathSounds[] =
{
	"hgrunt/gr_die1.wav",
	"hgrunt/gr_die2.wav",
	"hgrunt/gr_die3.wav",
...
const char* CBaseGrunt::pPainSounds[] =
{
	"hgrunt/gr_pain1.wav",
	"hgrunt/gr_pain2.wav",
	"hgrunt/gr_pain3.wav",
...
void CBaseGrunt::IdleSound(void)
{
...
Vector CBaseGrunt::GetGunPosition()
{
	if (m_fStanding)
	{
		return pev->origin + GRUNT_GUN_STANDING_POSITION;
	}
	else
	{
		return pev->origin + GRUNT_GUN_CROUCHING_POSITION;
	}
}
...
void CBaseGrunt::HandleAnimEvent(MonsterEvent_t *pEvent)
{
	...
	case HGRUNT_AE_KICK:
	{
		...
		if (pHurt)
		{
			...
			pHurt->SetVelocity(pHurt->GetVelocity() + gpGlobals->v_forward * 100 + gpGlobals->v_up * 50);
...
// Spawn
//=========================================================
void CBaseGrunt::Spawn()
{
	SetModel( (char*)STRING( GetModelName() ) );
	...
	ClearCapabilities();
	SetCapabilities(bits_CAP_SQUAD | bits_CAP_TURN_HEAD | bits_CAP_DOORS_GROUP);

	m_fEnemyEluded = FALSE;
	m_fFirstEncounter = TRUE;// this is true when the grunt spawns, because he hasn't encountered an enemy yet.

	m_HackedGunPos = GRUNT_HACKED_GUN_POSITION;
...
// PainSound
//=========================================================
void CBaseGrunt::PainSound(void)
{
...
// DeathSound 
//=========================================================
void CBaseGrunt::DeathSound(void)
{
...
IMPLEMENT_CUSTOM_SCHEDULES(CBaseGrunt, CSquadMonster);
